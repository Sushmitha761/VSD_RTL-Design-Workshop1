...
<img width="1600" height="883" alt="WhatsApp Image 2026-08-21 at 9 03 48 PM" src="https://github.com/user-attachments/assets/494d7986-be4d-449b-a533-52bdf6b00de3" />

**Synthesized Netlist**

<img width="1600" height="883" alt="WhatsApp Image 2026-08-21 at 9 03 53 PM" src="https://github.com/user-attachments/assets/d984b623-4b2e-464d-8497-d621978fe287" />
...
**Waveform**
<img width="1600" height="883" alt="WhatsApp Image 2026-08-21 at 9 04 26 PM" src="https://github.com/user-attachments/assets/99af4f08-ad29-4820-acbd-0ca1063e2ab4" />


**Synthesized Netlist**

<img width="1600" height="883" alt="WhatsApp Image 2026-08-21 at 9 04 27 PM (1)" src="https://github.com/user-attachments/assets/244d7440-b05a-4c9e-9941-18592651c316" />
...
**Waveform**
<img width="1920" height="940" alt="image" src="https://github.com/user-attachments/assets/ae589771-1049-4168-b55b-3c47eb38dda4" />
...
<img width="1600" height="883" alt="WhatsApp Image 2026-08-21 at 9 04 34 PM" src="https://github.com/user-attachments/assets/ba81f983-4036-4662-8350-b313f43188bc" />
...
**Waveform**
<img width="1920" height="940" alt="image" src="https://github.com/user-attachments/assets/9f25042b-30f6-4514-af23-4f87e2fb65f1" />
...
<img width="1600" height="883" alt="WhatsApp Image 2026-08-21 at 9 05 07 PM" src="https://github.com/user-attachments/assets/677e0271-517b-4e1f-b2c6-51144666975e" />
...
| **Feature**   | **CASE Statement** | **Procedural `for` Loop**   |
| ------------- | ------------------ | --------------------------- |
...
**Waveform**
<img width="1920" height="940" alt="image" src="https://github.com/user-attachments/assets/a3965ec4-1a25-4cc0-bd90-2a3d85f593d5" />
...
<img width="1920" height="940" alt="image" src="https://github.com/user-attachments/assets/95935059-2607-41b5-a638-3c3792a75c44" />
...
The following tools were used during the VSD RTL Design Workshop:

- **Yosys** – Used for RTL synthesis, logic optimization, and generation of gate-level netlists.
- **Icarus Verilog (iverilog)** – Used for compiling and simulating Verilog HDL designs.
- **GTKWave** – Used for viewing and analyzing simulation waveforms.
- **Verilog HDL** – Used for describing and implementing digital circuits at the RTL level.
- **Linux Terminal** – Used for executing synthesis, simulation, and analysis commands.
- **Git & GitHub** – Used for maintaining, organizing, documenting, and sharing the workshop work.
<img width="987" height="1507" alt="WhatsApp Image 2026-08-23 at 1 10 32 AM" src="https://github.com/user-attachments/assets/9888800e-1cee-4d71-893e-9c92d6bb3f6d" />


## Workshop Highlights

<img width="1599" height="1599" alt="WhatsApp Image 2026-08-23 at 12 53 20 AM" src="https://github.com/user-attachments/assets/69c26312-fd08-4db2-94e9-238fc5424fac" />



## Conclusion

The VSD RTL Design Workshop provided a comprehensive practical understanding of **RTL design, Verilog HDL, logic synthesis, and optimization techniques**. The workshop helped in understanding the complete **RTL-to-Gate-Level Netlist flow** and how synthesis tools such as **Yosys** are used to transform RTL descriptions into optimized hardware implementations.

During the workshop, different RTL designs were implemented using **Verilog HDL**, and their synthesis behavior was studied. The synthesis process helped in understanding how RTL code is analyzed, converted into logic elements, and optimized to generate an efficient synthesized netlist.

Various **combinational and sequential logic optimization techniques** were explored during the experiments. These included **constant propagation, unused output optimization, state optimization, logic cloning, and retiming**. Each optimization technique demonstrated how unnecessary logic can be removed or modified to improve the overall hardware implementation.

The workshop also provided hands-on experience in analyzing **synthesized netlists** and understanding the changes that occur before and after optimization. This helped in gaining a better understanding of how RTL coding styles and optimization commands can affect the final hardware structure.

The practical exercises performed using **Yosys** improved the understanding of **logic reduction, area optimization, timing considerations, and efficient hardware design**. The experiments also demonstrated the importance of writing optimized RTL code and selecting appropriate synthesis techniques for achieving better design results.

Overall, the VSD RTL Design Workshop significantly strengthened the understanding of **digital logic design, Verilog HDL, RTL synthesis, netlist generation, and optimization**. The knowledge and practical experience gained through this workshop provide a strong foundation for further learning in **VLSI, RTL design, digital IC design, and hardware synthesis**.
