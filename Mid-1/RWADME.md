...
gtkwave dump.vcd
GLS Result
The synthesized netlist was simulated successfully. The generated waveform verified that the synthesized design behaved correctly under the given test conditions. Glswaveform
